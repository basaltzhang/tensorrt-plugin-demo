...
#include "nonMaxSuppressionPlugin/nonMaxSuppressionInference.h"
#include "nonMaxSuppressionPlugin/gatherNMSOutputs.h"
#include "kernel.h"
#include "nmsUtils.h"
#include "plugin.h"
#include <string>
...
class NonMaxSuppressionPlugin : public IPluginV2DynamicExt
{
public:
    NonMaxSuppressionPlugin(NMSParameters param);

    NonMaxSuppressionPlugin(const void* data, size_t length);

    ~NonMaxSuppressionPlugin() override = default;
...
class NonMaxSuppressionPluginCreator : public BaseCreator
{
public:
    NonMaxSuppressionPluginCreator();

    ~NonMaxSuppressionPluginCreator() override = default;
...
#endif // TRT_NON_MAX_SUPPRESSION_PLUGIN_H
